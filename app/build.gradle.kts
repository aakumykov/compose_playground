...
android {
    namespace = "com.github.aakumykov.compose_playground"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.github.aakumykov.compose_playground"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
//    implementation("com.github.aakumykov:java-faker:525aaf096b")
